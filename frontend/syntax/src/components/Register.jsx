...
function Register() {
  return (
    <div className='signup-container'>
     ...
     <div className='form'>
        <div>
            <h1 className='font-Grotesk heading-register'>Create An Account</h1>
        </div>
...
<div className='form-inputs'>
    <div className='form_first-row'>
        <div>
            <label>First Name</label> <br/>
            <input className='name-input' type='text' name='firstname' placeholder='Enter your First Name'/>
        </div>
        <div>
        <label>Last Name</label> <br/>
        <input className='surname-input' type='text' name='lastname'  placeholder='Enter your Last Name'/>
        </div>
    </div>
